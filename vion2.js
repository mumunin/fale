			...
			var _directSource 		= 'aHR0cHM6Ly9kYS1kNTBkMTJiNS5vbmxpbmUubWVvLnB0L3dwL2Nkbi1lci12c3BwLWN2bDIub25saW5lLm1lby5wdC9zaGxzL0xJVkUkU1BPUlRUVjFfSEQvaW5kZXgubTN1OC9TIWQyRUlTVTlUWDB4cGRtVVNCa1BJUzFYRFZQNy4uLjhCRmd5Zi9MZXZlbCgzMDAwMDAwKQ==';
			var _loopCounter		= 0;
			...
			var _rebuildPlayer = function(_source, _target, _event){				
				...
				window.history.pushState({"pageTitle":_jsonData.nama_channel+' - Raket TV'},"", _target);
				...
				if(_jsonData.jenis == 'hls'){		
					playerInstance.setup({
						playlist: [{
                            "image": "https://cdn.jsdelivr.net/gh/habotv/cdn@master/rktplays.jpg",
							"title": _jsonData.nama_channel+" - Raket TV", 
							"sources": [
								{
									"default": false,                            
                      ...
                      stretching: "uniform",
						autostart: false,
						logo: {
							file: 'https://rawcdn.githack.com/mumunin/fale/21a9e6bd0f95f42dcdc65a9e8289641100720db4/icon.png',
							link: '/',
							position: 'top-right',
							hide: "false"
						},
						...
						$('.jw-error-text').html('An unexpected error occurred, <span class="jw-break jw-reset"></span>always use <strong>Chrome Browser</strong> and <strong> Hub. Admin Raket TV</strong> !!!');					   
						/* setTimeout(function(){
